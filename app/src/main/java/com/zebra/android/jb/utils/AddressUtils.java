package com.zebra.android.jb.utils;
...
public class AddressUtils {
	...
	public static String ID_CARD_EN ="/proc/jbcommon/gpio_control/id_card_en";
	public static String RFID_ENABLE = "/proc/jbcommon/gpio_control/rfid_enable";
	public static String BACK_UART_OE = "/proc/jbcommon/gpio_control/back_oe1";
	public static String BACK_UART_CS0 = "/proc/jbcommon/gpio_control/back_com_cs0";
	public static String BACK_UART_CS1 = "/proc/jbcommon/gpio_control/back_com_cs1";
	public static String IC_CARD_EN  = "/proc/jbcommon/gpio_control/ic_card_en";
}
