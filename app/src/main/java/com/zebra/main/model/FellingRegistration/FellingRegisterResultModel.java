...
public class FellingRegisterResultModel {
    ...
    public int getIsOldWoodSpieceCode() {
        return IsOldWoodSpieceCode;
    }

    public void setIsOldWoodSpieceCode(int isOldWoodSpieceCode) {
        IsOldWoodSpieceCode = isOldWoodSpieceCode;
    }
