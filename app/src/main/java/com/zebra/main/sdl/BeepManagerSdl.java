...
public class BeepManagerSdl {
	...
	public BeepManagerSdl(Context context, boolean playBeep, boolean vibrate) {
		super();
	...
	public boolean isVibrate() {
		Log.v(TAG,"isVibrate: "+vibrate +"mContext: "+mContext);
		vibrate = Preference.getScanVibration(mContext, true);
		return vibrate;
	}

	public void setVibrate(boolean vibrate) {
		Log.v(TAG,"setVibrate: "+vibrate);
...
//
//        Log.v("SDL","maxVolume: "+maxVolume+" currentVolume: "+currentVolume);
		if (null == mSoundPool) {
	...
	public void play() {
		...
		// vibrate
		Log.v(TAG,"play isVibrate(): "+isVibrate());
		if (vibrate) {
